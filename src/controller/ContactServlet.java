...
public class ContactServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		if (action != null) {
			if (action.equals("Rechercher")) {
				...
				if (idStr.equals("") == false && idStr.matches("\\p{Digit}+") == true) {
					...
					request.setAttribute("MessageErreur", "L'id doit être un entier");
				}
			}
			...
			if (action.equals("Ajouter")) {
				...
				if (idStr.equals("") == false && idStr.matches("\\p{Digit}+") == true
					...
					request.setAttribute("MessageErreur", "Tous les champs doivent être remplis");
				}
		...
		// on renvoie le message à la page jsp
